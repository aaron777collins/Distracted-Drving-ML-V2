...
class MultiPersonTrainer:
    def main(self):

        # id = "concat"

        print(f"Creating Logger for model for all concatenated data")
        self.logger = Logger( f"Models-Scores-allModels-nobk-macro-concat.txt")
        self.csvWriter = CSVWriter(f"Models-Scores-allModels-nobk-macro-concat.csv", CSV_COLUMNS)
